<template>
    <v-wait for="fetching stats">
        ...
        <div>
            ...
            <b-form-checkbox id="checkboxtt"
                     v-model="showtt">
                     тотал
            </b-form-checkbox>

            <b-form-checkbox id="checkboxavg"
                     v-model="showavg">
                     процент
            </b-form-checkbox>
            <b-form-checkbox id="checkboxper"
                     v-model="showper">
                     частота
            </b-form-checkbox>
            <b-form-checkbox id="checkboxsqr"
                     v-model="showsqr">
                     отклонение
            </b-form-checkbox>
        ...
        <table class="table table-striped ">
            ...
            <tbody v-for="time in rasklad.statistics">
                <tr>
                    <td>{{time.descr}}</td>
                    <td>{{time.count}}</td>
